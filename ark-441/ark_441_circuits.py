"""
ARK-441 — Circuit definitions (8 arms)
...
These map to physical qubits [5, 6] on ibm_kingston via initial_layout at transpile time.
...
# Preregistered physical qubit pair on ibm_kingston (Heron r2)
PHYSICAL_QA = 5
PHYSICAL_QP = 6
