"""
ARK-442 — In-situ SPAM estimation job (RUNS FIRST) on ibm_marrakesh
Remnant Fieldworks Inc. — Derek Hone

Directly characterizes SPAM readout error on the ARK-442 rule-selected physical
...
Kill gate (preregistered, Field 22): SPAM_baseline := p01 must be <= 0.02 on BOTH
qubits. If exceeded on either qubit => INDETERMINATE/KILLED: submit no principal job.
