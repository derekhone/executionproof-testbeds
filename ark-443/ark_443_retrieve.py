"""
ARK-443 — Principal job result retrieval
...
The payload readout is the classical register 'cp'; the 3-bit authorization
register 'ca' is also captured for diagnostic cross-checks.
"""
...
def main():
    ...
    for i, name in enumerate(arm_order):
        ...
        # Diagnostic: capture authorization register 'ca' if present (arm8 has none).
        try:
