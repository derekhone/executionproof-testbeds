"""
ARK-444 — Preregistered qubit selection on ibm_marrakesh (Heron r2)
Remnant Fieldworks Inc. — Derek Hone

Selection rule (preregistered, Field 10 — identical to ARK-441/446/442):
  ...
  - Lower physical index -> Q_A (deterministic).
