"""
ARK-444 — Principal 8-arm job submission
...
from ark_444_circuits import build_all_arms, INITIAL_LAYOUT, ARM_NAMES, ARM_CLASS
...
def check_spam_gate():
    ...
    if not os.path.exists(spam_path):
        print("[SUBMIT] ABORT: spam_results.json not found. Run ark_444_spam_job.py first.")
        sys.exit(2)
...
def main():
    ...
    print("[SUBMIT] job submitted and recorded. Use ark_444_retrieve.py to fetch results.")
