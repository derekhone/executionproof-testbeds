...
def main():
    ...
    secondary = {
        ...
        "H2c_confusion_falls_to_deny": {
            "L_conf": deny_raw["L_conf"], "L_conf_corrected": l_conf_corr,
            "denies": bool(confusion_denies),
...
def _make_plots(raw, ci95, allow_raw, deny_raw, deny_corrected, hold_raw,
    ...
    ax.set_title("ARK-445 (ibm_marrakesh) — Payload execution by arm (95% Wilson CI)\n"
    ...
    ax.set_title("ARK-445 (ibm_marrakesh) — Tri-state discrimination\n"
