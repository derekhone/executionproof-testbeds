"""
ARK-445b — Principal 9-arm job submission on ibm_marrakesh (Heron r2)
...
from ark_445b_circuits import build_all_arms, INITIAL_LAYOUT, ARM_NAMES, ARM_CLASS, ARM_EXPECT
