"""
ARK-446 — Principal 8-arm job submission
...
from ark_446_circuits import build_all_arms, INITIAL_LAYOUT, ARM_NAMES
...
def check_spam_gate():
    ...
    if not os.path.exists(spam_path):
        print("[SUBMIT] ABORT: spam_results.json not found. Run ark_446_spam_job.py first.")
        sys.exit(2)
...
def main():
    ...
    print("[SUBMIT] job submitted and recorded. Use ark_446_retrieve.py to fetch results.")
