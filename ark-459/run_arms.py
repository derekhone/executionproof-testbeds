#!/usr/bin/env python3
"""
ARK-459 — Run all 8 arms (800 scenarios total) and compute metrics.
...
def main():
    ...
    print("="*70)
    print("ARK-459 — Cloud IAM Role Grant · Revocation At Execution")
    print("="*70)
    ...
    overall = {
        "experiment": "ARK-459",
        "title": "Cloud IAM Role Grant · Revocation At Execution",
