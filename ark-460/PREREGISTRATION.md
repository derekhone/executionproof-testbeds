...
- **dependencies** dict: `{"PolicyRegistry": "AVAILABLE"|"UNAVAILABLE", "IdentityProvider": ..., "SignatureVerifier": ..., "AuditLogger": ...}`
...
| 2 | PolicyRegistry UNAVAILABLE | HOLD |
| 3 | IdentityProvider UNAVAILABLE | HOLD |
| 4 | SignatureVerifier UNAVAILABLE | HOLD |
| 5 | AuditLogger UNAVAILABLE | HOLD |
