#!/usr/bin/env python3
"""
ARK-460 — Run all 8 arms (800 scenarios total) and compute metrics.

Arms:
  1, 8: ALL-AVAILABLE → expect ALLOW
  2: PolicyRegistry UNAVAILABLE → expect HOLD
  3: IdentityProvider UNAVAILABLE → expect HOLD
  4: SignatureVerifier UNAVAILABLE → expect HOLD
  5: AuditLogger UNAVAILABLE → expect HOLD
...
ARM_NAMES = {
    1: "ALL-AVAILABLE", 2: "PolicyRegistry-UNAVAILABLE",
    3: "IdentityProvider-UNAVAILABLE", 4: "SignatureVerifier-UNAVAILABLE",
    5: "AuditLogger-UNAVAILABLE", 6: "MULTIPLE-UNAVAILABLE",
...
def main():
    ...
    overall = {
        "experiment": "ARK-460", "title": "Cloud IAM Role Grant · Dependency Loss",
