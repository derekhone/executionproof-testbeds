#!/usr/bin/env python3
"""ARK-461 — Run all 8 arms (800 scenarios) and compute metrics."""
...
def main():
    ...
    print("="*70 + "\nARK-461 — Cloud IAM Role Grant · Cross-Context Replay\n" + "="*70)
    ...
    overall = {"experiment": "ARK-461", "total_scenarios": sum(r["n"] for r in arm_results), "arms": arm_results,
