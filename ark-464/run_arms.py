#!/usr/bin/env python3
"""
ARK-464 — Run all 8 arms (800 scenarios total) and compute metrics.
...
def main():
    ...
    print("="*70)
    print("ARK-464 — Production Deployment · Revocation At Execution")
    print("="*70)
    ...
    overall = {
        "experiment": "ARK-464",
        "title": "Production Deployment · Revocation At Execution",
