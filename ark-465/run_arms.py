#!/usr/bin/env python3
"""
ARK-465 — Run all 8 arms (800 scenarios total) and compute metrics.

Arms:
  1, 8: ALL-AVAILABLE → expect ALLOW
  2: ServiceRegistry UNAVAILABLE → expect HOLD
  3: ConfigStore UNAVAILABLE → expect HOLD
  4: SecretVault UNAVAILABLE → expect HOLD
  5: DeploymentAuditor UNAVAILABLE → expect HOLD
...
ARM_NAMES = {
    1: "ALL-AVAILABLE", 2: "ServiceRegistry-UNAVAILABLE",
    3: "ConfigStore-UNAVAILABLE", 4: "SecretVault-UNAVAILABLE",
    5: "DeploymentAuditor-UNAVAILABLE", 6: "MULTIPLE-UNAVAILABLE",
...
def main():
    ...
    overall = {
        "experiment": "ARK-465", "title": "Production Deployment · Dependency Loss",
