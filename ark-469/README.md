# ARK-469 — Database Destructive Query · Revocation At Execution
...
ARK-469 tests database destructive query authorization with revocation at execution failure mode.
