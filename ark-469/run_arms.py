#!/usr/bin/env python3
"""
ARK-469 — Run all 8 arms (800 scenarios total) and compute metrics.
...
def main():
    ...
    print("="*70)
    print("ARK-469 — Production Database Query · Revocation At Execution")
    print("="*70)
    ...
    overall = {
        "experiment": "ARK-469",
        "title": "Production Database Query · Revocation At Execution",
