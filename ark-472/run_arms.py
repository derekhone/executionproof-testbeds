#!/usr/bin/env python3
"""ARK-472 — Run all 8 arms (800 scenarios)."""
...
def main():
    ...
    print("="*70 + "\nARK-472 — Production Database Query · Human Escalation\n" + "="*70)
    ...
    overall = {"experiment": "ARK-472", "total_scenarios": sum(r["n"] for r in arm_results), "arms": arm_results,
