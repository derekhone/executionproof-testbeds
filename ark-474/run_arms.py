#!/usr/bin/env python3
"""
ARK-474 — Run all 8 arms (800 scenarios total) and compute metrics.
...
def main():
    ...
    print("="*70)
    print("ARK-474 — Production Financial Transaction · Revocation At Execution")
    print("="*70)
    ...
    overall = {
        "experiment": "ARK-474",
        "title": "Production Financial Transaction · Revocation At Execution",
