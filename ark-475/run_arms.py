#!/usr/bin/env python3
"""
ARK-475 — Run all 8 arms (800 scenarios total) and compute metrics.

Arms:
  1, 8: ALL-AVAILABLE → expect ALLOW
  2: PaymentGateway UNAVAILABLE → expect HOLD
  3: FraudDetector UNAVAILABLE → expect HOLD
  4: AccountVerifier UNAVAILABLE → expect HOLD
  5: Financial TransactionAuditor UNAVAILABLE → expect HOLD
...
ARM_NAMES = {
    1: "ALL-AVAILABLE", 2: "PaymentGateway-UNAVAILABLE",
    3: "FraudDetector-UNAVAILABLE", 4: "AccountVerifier-UNAVAILABLE",
    5: "Financial TransactionAuditor-UNAVAILABLE", 6: "MULTIPLE-UNAVAILABLE",
...
def main():
    ...
    print("="*70 + "\nARK-475 — Production Financial Transaction · Dependency Loss\n" + "="*70)
    ...
    overall = {
        "experiment": "ARK-475", "title": "Production Financial Transaction · Dependency Loss",
