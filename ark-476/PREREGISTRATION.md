# ARK-476 Preregistration — Financial Transaction · Cross-Context Replay

**Experiment ID:** ARK-476  
...
Can a financial transaction authorized for one context be replayed in another? Tests 5-dimension context binding: tenant, session, resource, audience, environment.
