#!/usr/bin/env python3
"""
ARK-476 — Production Financial Transaction · Cross-Context Replay (scenario generator).
...
def generate_scenario(arm: int, idx: int) -> Dict[str, Any]:
    ...
    return {
        ...
        "execution": {
            "action": action,  # exact match on financial transaction action
