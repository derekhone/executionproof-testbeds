#!/usr/bin/env python3
"""ARK-477 — Run all 8 arms (800 scenarios)."""
...
def main():
    ...
    print("="*70 + "\nARK-477 — Production Financial Transaction · Human Escalation\n" + "="*70)
    ...
    overall = {"experiment": "ARK-477", "total_scenarios": sum(r["n"] for r in arm_results), "arms": arm_results,
