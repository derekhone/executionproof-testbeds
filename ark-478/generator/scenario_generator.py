#!/usr/bin/env python3
"""
ARK-478 Scenario Generator — API Rate Limit · Exact-Action Binding
...
def generate_arm_1_exact_match(n: int) -> List[Dict[str, Any]]:
    ...
    for i in range(n):
        ...
        scenarios.append({
            ...
            "authorized_request": base.copy(),
            "presented_request": base.copy(),
...
def main():
    ...
    print("Generating ARK-478 test scenarios...")
    print("=" * 70)
