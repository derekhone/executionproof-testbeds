# ARK-479 Preregistration — API Rate Limit · Revocation At Execution

**Experiment ID:** ARK-479  
...
Does the API rate limit guard handle revocation timing correctly, producing ALLOW/DENY/HOLD decisions based on API key revocation status at execution time?
