#!/usr/bin/env python3
"""
ARK-480 — Run all 8 arms (800 scenarios total) and compute metrics.

Arms:
  1, 8: ALL-AVAILABLE → expect ALLOW
  2: RateLimiter UNAVAILABLE → expect HOLD
  3: QuotaStore UNAVAILABLE → expect HOLD
  4: TokenValidator UNAVAILABLE → expect HOLD
  5: API Rate LimitAuditor UNAVAILABLE → expect HOLD
...
ARM_NAMES = {
    1: "ALL-AVAILABLE", 2: "RateLimiter-UNAVAILABLE",
    3: "QuotaStore-UNAVAILABLE", 4: "TokenValidator-UNAVAILABLE",
    5: "API Rate LimitAuditor-UNAVAILABLE", 6: "MULTIPLE-UNAVAILABLE",
...
def main():
    ...
    print("="*70 + "\nARK-480 — Production API Rate Limit · Dependency Loss\n" + "="*70)
    ...
    overall = {
        "experiment": "ARK-480", "title": "Production API Rate Limit · Dependency Loss",
