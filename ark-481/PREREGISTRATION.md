# ARK-481 Preregistration — API Rate Limit · Cross-Context Replay

**Experiment ID:** ARK-481  
...
Can an API rate limit authorization for one context be replayed in another? Tests 5-dimension context binding: tenant, session, resource, audience, environment.
